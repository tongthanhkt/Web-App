...
router.post('/lecturer/lecturer_change_profile', authController.lecturer_change_profile);

//Lecturer - chức năng Change Password
router.post('/lecturer/lecturer_change_password', authController.lecturer_change_password);
