...
router.post(
  "/staff/staff_change_password",
  authController.staff_change_password
);

//Staff - chức năng Search Accounts
router.post(
  "/staff/staff_search_accounts",
  authController.staff_search_accounts
);
...
router.post(
  "/staff/staff_create_course_file",
  authController.staff_create_course_file
);

// LECTURER

//Lecturer- chức năng Change Profile - Sửa đổi thông tin tài khoản
router.post(
  "/lecturer/lecturer_change_profile",
  authController.lecturer_change_profile
);

//Lecturer - chức năng Change Password
router.post(
  "/lecturer/lecturer_change_password",
  authController.lecturer_change_password
);
