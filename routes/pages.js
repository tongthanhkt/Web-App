...
router.get(
  "/lecturer/lecturer_view_student2/:subid.:subyear.:subSemester.:subClass",
  (req, res) => {
...
router.get(
  "/lecturer/lecturer_edit_student2/:subid.:subyear.:subSemester.:subClass",
  (req, res) => {
    console.log("SubID", req.params);
    let { subid, subyear, subSemester, subClass } = req.params;
    var id = localStorage.getItem("ID");
...
router.post("/lecturer/lecturer_edit_student2/edit", (req, res) => {
  let { midterm, final, total, subId, year, semester, classId, studentId } =
    req.body;
  var id = localStorage.getItem("ID");
